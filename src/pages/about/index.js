    ...
    <Layout>
      ...
      <Container>
        ...
        <div>
          <h3>News</h3>
          <p>
            Eindrücke aus dem Studienalltag der Masterstudierenden, aktuelle Informationen und Updates zu neuen Features
            findest du hier:
          </p>
          <p>
            Alle Informationen zu den einzelnen Masterstudiengängen sind mit bestem Wissen und Gewissen recherchiert und
            basieren auf der Analyse der Prüfungs-und Studienordnungen sowie der Selbstdarstellung der Studiengänge auf
            der jeweiligen Hochschulseite (Stand Mai 2017).
          </p>
        </div>
      </Container>
    </Layout>
